    ...
    <table class="min-w-full border-collapse">
        <thead>
            <tr >
                ...
                <th class="py-1 px-2 border-b ">Номер медкарты</th>
                <th class="py-1 px-2 border-b ">Дата обсервации</th>
                <th class="py-1 px-2 border-b ">Причина </th>
        ...
        <tbody id="list">
            ...
            @foreach($relatedUsers as $resident)
                <tr>
                    ...
                    <td class="py-2 px-1 border-b">{{ $resident->numberMC }} </td>
                    <td class="py-2 px-1 border-b">{{ $resident->dateOfRegistration}}</td>
                    <td class="py-2 px-1 border-b">{{ $resident->reasonForRegistration }}</td>
                    <td class="py-2 px-1 border-b">
                        <a href="{{ url('fillMedicalCard',$resident->id)}} class="text-blue-500 hover:text-blue-700">
                    ...
                    <td class="py-2 px-1 border-b">
                        <a onclick="return confirm('Вы хотите удалить?')" href="{{ url('deleteMedicalCard', $resident->id )}}" class="text-blue-500 hover:text-blue-700">
                            <edit-icon style="align: center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
