  ...
  <body>
    ...
    <div class="container-fluid page-body-wrapper">
        <div class="container mx-auto">
            ...
            <form  action="{{ url('editInfection', $data->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
            <div class="form-container">
                <div class="form-column">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="diagnos" id="title" value="{{ $data->diagnos }}">
                    </div>
